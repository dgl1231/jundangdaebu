...
app.get('/loanlist', (req, res) => {
    ...
    const loanListSql = "SELECT l.loan_no, LOAN_PRINCIPAL, PRODUCT, ce.G_ID, G_NAME, u.NAME, d.DOCU_PATH FROM dgl1231.loan l, dgl1231.security s, dgl1231.code_entity ce, dgl1231.code_group cg, dgl1231.user u, dgl1231.document d WHERE l.loan_no = s.loan_no AND ce.C_ID = s.PRODUCT AND cg.G_ID = ce.G_ID AND l.CALL_NO = u.CALL_NO AND d.LOAN_NO = l.LOAN_NO ORDER BY l.loan_no DESC;";
